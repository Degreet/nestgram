...
export abstract class GeneratedBotMethods {
  ...
  editMessageCaption(callOptions?: MethodOptions<EditMessageCaptionOptions>) {
    const { token, signal, ...rest } = callOptions ?? {};
    return this.call(new EditMessageCaption(rest), { token, signal });
  }
  ...
  editMessageMedia(
    ...
    callOptions?: MethodOptions<Omit<EditMessageMediaOptions, 'media'>>,
  ) {
    const { token, signal, ...rest } = callOptions ?? {};
    return this.call(new EditMessageMedia({ media, ...rest }), {
      token,
      signal,
    });
  }
  ...
  stopMessageLiveLocation(
    ...
    const { token, signal, ...rest } = callOptions ?? {};
    return this.call(new StopMessageLiveLocation(rest), { token, signal });
  }
